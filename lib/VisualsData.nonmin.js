    ...
    !function(data) {
        ...
        !function(DataViewConcatenateCategoricalColumns) {
            ...
            function concatenateValues(columnsSortedByProjectionOrdering, queryRefsToIgnore) {
                for (var concatenatedValues = [], _i = 0; _i < columnsSortedByProjectionOrdering.length; _i++) for (var categoryColumn = columnsSortedByProjectionOrdering[_i], i = 0, len = categoryColumn.values.length; len > i; i++) if (!_.contains(queryRefsToIgnore, categoryColumn.source.queryName)) {
        ...
        !function(DataViewTransform) {
            ...
            function applyRewritesToCategorical(prototype, columnRewrites, selectsToInclude) {
                ...
                if (values) {
                    ...
                    for (var group, currentGroupIndex = 0, i = 0, ilen = values.length; ilen > i; i++) {
            ...
            !function(DataViewMatrixUtils) {
                ...
                function containsCompositeGroup(matrixOrHierarchy) {
                    ...
                    if (matrixOrHierarchy) if (isMatrix(matrixOrHierarchy)) hasCompositeGroup = containsCompositeGroup(matrixOrHierarchy.rows) || containsCompositeGroup(matrixOrHierarchy.columns); else {
                        ...
                        if (!_.isEmpty(hierarchyLevels)) for (var _i = 0; _i < hierarchyLevels.length; _i++) {
                            var level = hierarchyLevels[_i];
